...
{
    public class OverlayNode : NodeBase
    {
        ...
        public override Texture2D ApplyNode()
        {
            ...
            for (int x = 0; x < width; x++)
            {
                for (int y = 0; y < height; y++)
                {
                    ...
                    newPixels[i].r = pixels[i1].a * (r1 - r2) + r2;
                    newPixels[i].g = pixels[i1].a * (g1 - g2) + g2;
                    newPixels[i].b = pixels[i1].a * (b1 - b2) + b2;

                    newPixels[i].a = Mathf.Max(pixels[i1].a, bottomPixels[i2].a);
                }
            }
